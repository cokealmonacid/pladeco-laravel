...
@section('content')
	...
	<a href="/administrador/lineamientos"><< Volver</a>
						...
						@if($componente->lineamiento_id === $lineamiento->id)
							<div class="panel panel-success">
							  ...
							  <div class="panel-body">
								...
								<button id="more-administrador"><a href="/administrador/componentes/{!! $componente->id !!}/iniciativas">Ver Iniciativas</a></button>
							  </div>
							</div>
						@endif
					@endforeach
